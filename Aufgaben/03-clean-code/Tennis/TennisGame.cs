...
public class TennisGameManager
{
    ...
    private readonly string Five_teen = "Fifteen";
    ...
    public string Score_Getter()
    {
        ...
        if (p1point > p2point && p2point >= 3) s = "Advantage player1";

        if (p2point > p1point && p1point >= 3) s = generate_Player_2_Name();

        if (p1point >= 4 && p2point >= 0 && p1point - p2point >= 2) s = "Win for player1";
    ...
    {
        if (y >= 4 && q >= 0 && y - q >= 2) return "Win for player2";
        return s;
    }

    public void SetPlayer1Score(int number)
    {
        for (var i = 0; i < number; i++) P1Score();
    }

    public void SetP2Score(int number)
    {
        for (var i = 0; i < number; i++) SecondPlayerScore();
    }
